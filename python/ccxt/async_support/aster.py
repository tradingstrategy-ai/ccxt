...
class aster(Exchange, ImplicitAPI):
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response: dict = await self.publicGetFapiV1ExchangeInfo(params)
    ...
    async def fetch_time(self, params={}) -> Int:
        ...
        """
        response = await self.publicGetFapiV1Time(params)
        #
        #     {
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        if isMark:
            ...
            response = await self.publicGetFapiV1MarkPriceKlines(self.extend(request, params))
        elif isIndex:
            request['pair'] = market['id']
            response = await self.publicGetFapiV1IndexPriceKlines(self.extend(request, params))
        else:
            request['symbol'] = market['id']
            response = await self.publicGetFapiV1Klines(self.extend(request, params))
        #
        #     [
        #         [
        #             1631158560000,
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            ...
            request['limit'] = limit
        response = await self.publicGetFapiV1Trades(self.extend(request, params))
        #
        #     [
        #         {
        #             "id": 3913206,
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            ...
            request['limit'] = limit
        request, params = self.handle_until_option('endTime', request, params)
        response = await self.privateGetFapiV1UserTrades(self.extend(request, params))
        #
        #     [
        #         {
        #             "buyer": False,
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if limit is not None:
            ...
            if limit > 1000:
                limit = 1000  # Default 500; max 1000.
            request['limit'] = limit
        response = await self.publicGetFapiV1Depth(self.extend(request, params))
        #
        #     {
    ...
    async def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            ...
            request['limit'] = limit
        request, params = self.handle_until_option('endTime', request, params)
        response = await self.publicGetFapiV1FundingRate(self.extend(request, params))
        #
        #     [
        #         {
        #             "symbol": "BTCUSDT",
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = await self.publicGetFapiV1Ticker24hr(self.extend(request, params))
        #
        #     {
        #         "symbol": "BTCUSDT",
        #         "priceChange": "1845.7",
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        response = await self.publicGetFapiV1Ticker24hr(params)
        #
        #     [
        #         {
        #             "symbol": "BTCUSDT",
    ...
    async def fetch_funding_rate(self, symbol: str, params={}) -> FundingRate:
        ...
        response = await self.publicGetFapiV1PremiumIndex(self.extend(request, params))
        #
        #     {
        #         "symbol": "BTCUSDT",
        #         "markPrice": "106729.84047826",
    ...
    async def fetch_funding_rates(self, symbols: Strings = None, params={}) -> FundingRates:
        ...
        await self.load_markets()
        symbols = self.market_symbols(symbols)
        response = await self.publicGetFapiV1PremiumIndex(self.extend(params))
        #
        #     [
        #         {
        #             "symbol": "BTCUSDT",
    ...
    async def fetch_balance(self, params={}) -> Balances:
        ...
        """
        response = await self.privateGetFapiV2Balance(params)
        #
        #     [
        #         {
    ...
    async def fetch_position_mode(self, symbol: Str = None, params={}):
        ...
        """
        response = await self.privateGetFapiV1PositionSideDual(params)
        #
        #     {
    ...
    async def set_position_mode(self, hedged: bool, symbol: Str = None, params={}):
        ...
        #     }
        #
        return await self.privatePostFapiV1PositionSideDual(self.extend(request, params))
    ...
    async def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        response = await self.privateGetFapiV1CommissionRate(self.extend(request, params))
        #
        #     {
        #         "symbol": "BTCUSDT",
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}):
        ...
        if clientOrderId is not None:
            ...
            request['orderId'] = id
        response = await self.privateGetFapiV1Order(self.extend(request, params))
        #
        #     {
        #         "avgPrice": "0.00000",
        #         "clientOrderId": "abc",
    ...
    async def fetch_open_order(self, id: str, symbol: Str = None, params={}):
        ...
        if clientOrderId is not None:
            ...
            request['orderId'] = id
        response = await self.privateGetFapiV1OpenOrder(self.extend(request, params))
        #
        #     {
        #         "avgPrice": "0.00000",
        #         "clientOrderId": "abc",
    ...
    async def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            ...
            request['limit'] = limit
        request, params = self.handle_until_option('endTime', request, params)
        response = await self.privateGetFapiV1AllOrders(self.extend(request, params))
        #
        #     [
        #         {
        #             "avgPrice": "0.00000",
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if symbol is not None:
            market = self.market(symbol)
            request['symbol'] = market['id']
        response = await self.privateGetFapiV1OpenOrders(self.extend(request, params))
        #
        #     [
        #         {
        #             "avgPrice": "0.00000",
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        response = None
        if test:
            response = await self.privatePostFapiV1OrderTest(request)
        else:
            response = await self.privatePostFapiV1Order(request)
        return self.parse_order(response, market)
    ...
    async def create_orders(self, orders: List[OrderRequest], params={}):
        ...
        response = await self.privatePostFapiV1BatchOrders(self.extend(request, params))
 ...
 @ignore
    ...
    async def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        response = await self.privateDeleteFapiV1AllOpenOrders(self.extend(request, params))
        #
        #     {
        #         "code": "200",
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = await self.privateDeleteFapiV1Order(self.extend(request, params))
        return self.parse_order(response, market)
 ...
 EXCHANGE SPECIFIC PARAMETERS
        ...
        response = await self.privateDeleteFapiV1BatchOrders(self.extend(request, params))
        #
        #    [
        #        {
    ...
    async def set_leverage(self, leverage: int, symbol: Str = None, params={}):
        ...
        response = await self.privatePostFapiV1Leverage(self.extend(request, params))
        #
        #     {
        #         "leverage": 21,
    ...
    async def fetch_leverages(self, symbols: Strings = None, params={}) -> Leverages:
        ...
        """
        await self.load_markets()
        response = await self.privateGetFapiV2PositionRisk(params)
        #
        #     [
        #         {
        #             "symbol": "INJUSDT",
    ...
    async def fetch_margin_adjustment_history(self, symbol: Str = None, type: Str = None, since: Num = None, limit: Num = None, params={}) -> List[MarginModification]:
        ...
        response = await self.privateGetFapiV1PositionMarginHistory(self.extend(request, params))
        #
        #     [
        #         {
        #             "amount": "23.36332311",
    ...
    async def modify_margin_helper(self, symbol: str, amount, addOrReduce, params={}):
        ...
        code = market['quote']
        response = await self.privatePostFapiV1PositionMargin(self.extend(request, params))
        #
        #     {
        #         "amount": 100.0,
        #         "code": 200,
    ...
    async def fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = await self.privateGetFapiV1Income(self.extend(request, params))
    ...
    async def fetch_positions_risk(self, symbols: Strings = None, params={}):
        ...
        await self.load_markets()
        request: dict = {}
        response = await self.privateGetFapiV2PositionRisk(self.extend(request, params))
        #
        #     [
        #         {
        #             "entryPrice": "6563.66500",
 ...
 @ignore
        ...
        response = await self.privateGetFapiV2Account(params)
        filterClosed = None
    ...
    async def load_leverage_brackets(self, reload=False, params={}):
        ...
        if (leverageBrackets is None) or (reload):
            ...
            response = await self.privateGetFapiV1LeverageBracket(query)
